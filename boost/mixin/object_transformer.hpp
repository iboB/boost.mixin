...
//
#pragma once
#if !defined(_BOOST_MIXIN_OBJECT_TRANSFORMER_HPP_INCLUDED)
#define _BOOST_MIXIN_OBJECT_TRANSFORMER_HPP_INCLUDED
...
#endif // _BOOST_MIXIN_OBJECT_TRANSFORMER_HPP_INCLUDED
