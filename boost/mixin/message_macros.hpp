...
#define BOOST_MIXIN_CONST_MESSAGE_N(return_type, message, args)
#define BOOST_MIXIN_MULTICAST_MESSAGE_N(return_type, message, args)
#define BOOST_MIXIN_CONST_MULTICAST_MESSAGE_N(return_type, message, args)
#define BOOST_MIXIN_EXPORTED_MESSAGE_N(export, return_type, message, args)
#define BOOST_MIXIN_EXPORTED_CONST_MESSAGE_N(export, return_type, message, args)
#define BOOST_MIXIN_EXPORTED_MULTICAST_MESSAGE_N(export, return_type, message, args)
#define BOOST_MIXIN_EXPORTED_CONST_MULTICAST_MESSAGE_N(export, return_type, message, args)
#define BOOST_MIXIN_MESSAGE_N_OVERLOAD(message_name, return_type, method_name, args)
#define BOOST_MIXIN_CONST_MESSAGE_N_OVERLOAD(message_name, return_type, method_name, args)
#define BOOST_MIXIN_MULTICAST_MESSAGE_N_OVERLOAD(message_name, return_type, method_name, args)
#define BOOST_MIXIN_CONST_MULTICAST_MESSAGE_N_OVERLOAD(message_name, return_type, method_name, args)
#define BOOST_MIXIN_EXPORTED_MESSAGE_N_OVERLOAD(export, message_name, return_type, method_name, args)
#define BOOST_MIXIN_EXPORTED_CONST_MESSAGE_N_OVERLOAD(export, message_name, return_type, method_name, args)
#define BOOST_MIXIN_EXPORTED_MULTICAST_MESSAGE_N_OVERLOAD(export, message_name, return_type, method_name, args)
#define BOOST_MIXIN_EXPORTED_CONST_MULTICAST_MESSAGE_N_OVERLOAD(export, message_name, return_type, method_name, args)
#else
