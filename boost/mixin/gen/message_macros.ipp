...
#define _BOOST_MIXIN_MESSAGE0_DECL(export, domain, message_name, method_name, return_type, constness, message_mechanism ) \
    ...
    { \
        typedef return_type (::boost::mixin::internal::dummy_type::*method_t)() constness;\
        ...
        return_type (Mixin::*get_method_pointer_for())() constness \
        { \
            /* use static_cast to show that we mean exactly the method with this signature and not some overload */ \
            return static_cast<return_type (Mixin::*)() constness>(&Mixin::method_name); \
        } \
    }; \
...
#define _BOOST_MIXIN_MESSAGE1_DECL(export, domain, message_name, method_name, return_type, constness, message_mechanism , arg0_type, a0) \
    ...
    struct export _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name) : public ::boost::mixin::internal::message_t \
    { \
        typedef return_type (::boost::mixin::internal::dummy_type::*method_t)(arg0_type) constness;\
        _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name)() \
            : ::boost::mixin::internal::message_t(BOOST_PP_STRINGIZE(message_name), message_mechanism) \
        {} \
        template <typename Mixin> \
        return_type (Mixin::*get_method_pointer_for())(arg0_type) constness \
        { \
            /* use static_cast to show that we mean exactly the method with this signature and not some overload */ \
            return static_cast<return_type (Mixin::*)(arg0_type) constness>(&Mixin::method_name); \
        } \
    }; \
    /* step 2: define a message tag, that will be used to identify the message in feature lists */ \
    /* it would have been nice if we could set this global variable to the unique global instance of the feature*/ \
...
#define _BOOST_MIXIN_MESSAGE2_DECL(export, domain, message_name, method_name, return_type, constness, message_mechanism , arg0_type, a0, arg1_type, a1) \
    ...
    struct export _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name) : public ::boost::mixin::internal::message_t \
    { \
        typedef return_type (::boost::mixin::internal::dummy_type::*method_t)(arg0_type, arg1_type) constness;\
        _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name)() \
            : ::boost::mixin::internal::message_t(BOOST_PP_STRINGIZE(message_name), message_mechanism) \
        {} \
        template <typename Mixin> \
        return_type (Mixin::*get_method_pointer_for())(arg0_type, arg1_type) constness \
        { \
            /* use static_cast to show that we mean exactly the method with this signature and not some overload */ \
            return static_cast<return_type (Mixin::*)(arg0_type, arg1_type) constness>(&Mixin::method_name); \
        } \
    }; \
    /* step 2: define a message tag, that will be used to identify the message in feature lists */ \
    /* it would have been nice if we could set this global variable to the unique global instance of the feature*/ \
...
#define _BOOST_MIXIN_MESSAGE3_DECL(export, domain, message_name, method_name, return_type, constness, message_mechanism , arg0_type, a0, arg1_type, a1, arg2_type, a2) \
    ...
    struct export _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name) : public ::boost::mixin::internal::message_t \
    { \
        typedef return_type (::boost::mixin::internal::dummy_type::*method_t)(arg0_type, arg1_type, arg2_type) constness;\
        _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name)() \
            : ::boost::mixin::internal::message_t(BOOST_PP_STRINGIZE(message_name), message_mechanism) \
        {} \
        template <typename Mixin> \
        return_type (Mixin::*get_method_pointer_for())(arg0_type, arg1_type, arg2_type) constness \
        { \
            /* use static_cast to show that we mean exactly the method with this signature and not some overload */ \
            return static_cast<return_type (Mixin::*)(arg0_type, arg1_type, arg2_type) constness>(&Mixin::method_name); \
        } \
    }; \
    /* step 2: define a message tag, that will be used to identify the message in feature lists */ \
    /* it would have been nice if we could set this global variable to the unique global instance of the feature*/ \
...
#define _BOOST_MIXIN_MESSAGE4_DECL(export, domain, message_name, method_name, return_type, constness, message_mechanism , arg0_type, a0, arg1_type, a1, arg2_type, a2, arg3_type, a3) \
    ...
    struct export _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name) : public ::boost::mixin::internal::message_t \
    { \
        typedef return_type (::boost::mixin::internal::dummy_type::*method_t)(arg0_type, arg1_type, arg2_type, arg3_type) constness;\
        _BOOST_MIXIN_MESSAGE_STRUCT_NAME(message_name)() \
            : ::boost::mixin::internal::message_t(BOOST_PP_STRINGIZE(message_name), message_mechanism) \
        {} \
        template <typename Mixin> \
        return_type (Mixin::*get_method_pointer_for())(arg0_type, arg1_type, arg2_type, arg3_type) constness \
        { \
            /* use static_cast to show that we mean exactly the method with this signature and not some overload */ \
            return static_cast<return_type (Mixin::*)(arg0_type, arg1_type, arg2_type, arg3_type) constness>(&Mixin::method_name); \
        } \
    }; \
    /* step 2: define a message tag, that will be used to identify the message in feature lists */ \
    /* it would have been nice if we could set this global variable to the unique global instance of the feature*/ \
